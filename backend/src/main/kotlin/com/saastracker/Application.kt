...
fun Application.module() {
    ...
    routing {
        ...
        subscriptionRoutes(subscriptionService, userRepository, companyRepository, stripeBillingService, rateLimiter)
        dashboardRoutes(dashboardService, userRepository, companyRepository, stripeBillingService)
        notificationRoutes(notificationService, userRepository, companyRepository, stripeBillingService)
